...
import 'package:flutter_movie/src/bloc/genrebloc/genre_bloc.dart';
import 'package:flutter_movie/src/bloc/genrebloc/genre_event.dart';
import 'package:flutter_movie/src/bloc/genrebloc/genre_state.dart';
...
import 'package:flutter_movie/src/model/genre.dart';
  ...
  Widget _buildGenre(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          child: Text(
            'new playing moviez'.toUpperCase(),
            style: TextStyle(
              fontSize: 12,
              fontWeight: FontWeight.bold,
              color: Colors.black45,
